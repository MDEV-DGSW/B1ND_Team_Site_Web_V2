...
const InquiryList = () => {
  ...
  const questionList = [
...

    {
      ...
      answer: '개인마다 1년에 4번 ~ 5번 사용이 가능하며, 개인적인 사정이있거나, 쉬고싶을때 언제든지 사용 가능합니다.'
    },

    {
      id: 7,
      question: '회고는 언제하고 어떻게 진행되나요?',
      answer: '연말에 모든 바인드 팀원들이 모여서 다양한 얘기를 하며 1년동안의 활동을 되돌아봅니다'
    },
      ...
      <div className ="InquiryList-TitleBox">
        <div className ="InquiryList-TitleBox-Contents">
          <div className ="InquiryList-TitleBox-Title">
            문의사항
            <button className ="InquiryList-TitleBox-WriteButton" onClick ={() => window.open('mailto://mdev_team@dgsw.hs.kr', '_blank')}>문의 하기</button>
          </div>
